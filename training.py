...
parser.add_argument('--label_dir', type=str, default="../seqs")
...
parser.add_argument('--contrast', type=str, default="0.1")
parser.add_argument('--encoder', type=str, default="0")
parser.add_argument('--alpha', type=str, default="0.75")
...
param_str = f'M{PREFIX}_scale{HDIM}_ie{ENCODER_TYPE}_te{TEXT_ENCODER_TYPE}_batch{BATCH_SIZE}_contrast{CONTRASTIVE_LOSS_WEIGHT}_alpha{ALPHA}_fa{FULL_ATTN}_lr{LR}_gamma{GAMMA}'
MODEL_DIR = f'../checkpoints/{param_str}'
LOG_DIR = f'../log/{param_str}.txt'
