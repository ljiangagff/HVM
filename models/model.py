...
def decoder_initiator(device, scale='Base'):
...
class Model(nn.Module):
    def __init__(self, vocab, device,
        ...
        self.decoder= decoder_initiator(device, scale)
        ...
        print(f'contrast loss weight {self.contrastive_loss_weight}, caption_loss_weight {self.caption_loss_weight}')
    ...
    def forward(self, input, teaching_force):
        ...
        if self.caption_loss_weight:
            ...
            # output_len, bsz, vocab_size: (n, b, c)
